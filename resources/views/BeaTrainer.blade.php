...
<head>
    ...
    <link rel="icon" href="{{asset('assets/mages/favicon.ico')}}" type="image/x-icon">
...
.amsify-suggestags-input-area.form-control {
    margin: 0;
    position: relative;
    top: -3px;
}
...
<body>
	<!-- Sign in Banner -->
	<section class="signin-banner beacome-banner ">
		<div class="signinheader position-relative">
			<div class="container">
				<div class="d-flex justify-content-between">
					<a href="{{url('/home')}}" class="logo"><img src="{{asset('assets/images/logo.svg')}}" alt=""></a>

					<a href="{{url('/home')}}" class="f-16 fr white mb-0"><img class="mr-2" src="{{asset('assets/images/close.svg')}}" alt="">Close</a>
				</div>
			</div>
		</div>

		<div class="signin-content beacome_trainer position-relative">
			<div class="container">
				<div class="signin-content-col">
					<div>
						<h2 class="title f-46 fm white text-center">Be a Trainer</h2>
						<p class="f-18 fr white mb-0 text-center">Create Your Account</p>
						<div class="signin-field-block d-sm-flex d-block">
							<div class="col-12">
                               
								<form action="javascript:void(0)" id="fitness_trainer_form" method="Post" enctype="multipart/form-data">
                                    <div class="row">
                                       
                                        <div class="col-sm-6">
                                            <div class="form-group form-group-transparent">
                                                <label class="f-16 fr white">Full Name <span class="stike">*</span></label>
                                                <div class="input-group">
                                                    <input type="text"   id="name"  name="name" onkeyup="this.value=this.value.replace(/[^a-z A-Z]/g,'');"  required="true" class="form-control" placeholder="Enter Full Name">
                                                </div>
                                            </div>
                                         </div>
                                         <div class="col-sm-6">
                                            <div class="form-group form-group-transparent">
                                                <label class="f-16 fr white">Email  <span class="stike">*</span></label>
                                                <div class="input-group">
                                                    <input type="email" name="email" required="true" id="email" class="form-control" placeholder="Enter Email Address">
                                                </div>
                                                <span id="email_error" style="color:Red;display: none;"></span>
                                            </div>
                                         </div> 
                                         <div class="col-sm-6">
                                            <div class="form-group form-group-transparent" style="margin-top: 20px;">
                                                <label class="f-16 fr white">Mobile Number <span class="stike">*</span></label>
                                                <div class="input-group input-group-inline">
                                                    <input type="hidden" id="country_code"  name="country_code"/>
                                                    <input type="text" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" class="form-control" maxlength="10" minlength="10" required="true" id="phone" name="mobile_number" placeholder="Mobile Number">
                                                    <span id="mobile_number_error" style="color:Red; display: none;"></span>
                                                </div>
                                            </div>
                                         </div>
                                         <div class="col-sm-6">
                                            <div class="form-group form-group-transparent" style="margin-top: 20px;">
                                                <label class="f-16 fr white">Gender</label>
                                                <div class="input-group input-group-inline">
                                                    ...
                                                    <span class="fii-select-dropdown-d s_ar"></span>
                                                </div>
                                            </div>
                                         </div> 
                                         <div class="col-sm-6">
                                            <div class="form-group form-group-transparent" style="margin-top: 20px;">
                                                <label class="f-16 fr white">Specialization<span class="stike">*</span></label>
                                                <div class="input-group">
                                                    <input type="text"  class="form-control" required="true" placeholder="Enter Specialization" id="specialization" name="specialization[]">
                                                </div>
                                            </div>
                                         </div>
                                         <div class="col-sm-6">
                                            <div class="form-group form-group-transparent" style="margin-top: 20px;">
                                                <label class="f-16 fr white">Upload Document   <span class="stike">*</span></label>
                                                <div class="input-group">
                                                <!-- <label for="upload_doc"  class="upload_dov form-control text-center"><span class="mr-2"><img src="{{asset('assets/images/extra/upload-doc.svg')}}" alt=""></span> Upload Certificate</label> -->
                                                <input type="file" class="form-control" id="upload_doc" required="true" name="upload_doc[]" multiple accept="application/pdf,application/msword,
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group form-group-transparent" style="margin-top: 20px;">
                                            <label class="f-16 fr white">Location/Address   <span class="stike">*</span></label>
                                            <div class="input-group">
                                                <input type="text"  class="form-control" required="true" placeholder="Enter Address" id="address" name="address">
                                            </div>
                                        </div>
                                     </div>
...
<!-- 									<button type="submit" data-toggle="modal" data-target="#b_trainer" class="btn btn-xs btn-primary mt-3">Submit</button> -->
                                <button type="submit"  class="btn btn-xs btn-primary mt-3 btn_submit_tranning">Submit
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content pt-5 pb-5">
        <div class="modal-body text-center ">
          ...
          <h4>Success!</h4>
          <p>Thank you for becoming a part of Fitness Storm <br>
            community. We will contact you soon.</p>
        </div>
...
<script type="text/javascript">
   ...
   var fname = myfile.split('fakepath').pop();
