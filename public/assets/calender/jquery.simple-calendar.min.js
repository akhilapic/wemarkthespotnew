    ...
    t.extend(d.prototype, {
        ...
        buildCalendar: function (e, n) {
            ...
            if (!1 !== this.settings.fixedStartDay) {
                for (c = !0 === this.settings.fixedStartDay ? 1 : this.settings.fixedStartDay; h.getDay() !== c; ) h.setDate(h.getDate() - 1);
            ...
            for (var u = h; u <= l; u.setDate(u.getDate())) {
                var g = t("<tr></tr>");
                for (v = 0; v < 7; v++) {
                    var f = t('<td><div class="day active" data-date="' + u.toISOString() + '">' + u.getDate() + "</div></td>"),
                        D = f.find(".day");
                    ...
                    p.length && a.settings.displayEvent ? D.addClass(a.settings.disableEventDetails ? "has-event disabled" : "has-event") : D.addClass(a.settings.disableEmptyDetails ? "disabled" : ""),
                        ...
                        this.settings.onDayCreate(D, u.getDate(), o, r),
                        g.append(f),
